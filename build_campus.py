...
AFRAME.registerComponent('campus',{
  init:function(){
    ...
    // ===== grand library terminus (USC Doheny-inspired Romanesque hall + campanile) =====
    var lib=document.createElement('a-entity'); lib.setAttribute('position','0 0 -130');
    (window.COLLIDERS=window.COLLIDERS||[]).push({t:'r',x:0,z:-130,hw:9.4,hd:5});
    (window.COLLIDERS=window.COLLIDERS||[]).push({t:'r',x:-6.5,z:-128,hw:2.4,hd:2.4});
    var lh='';
    lh+='<a-box position="0 0.5 0" width="18.6" height="1.0" depth="9.3" material="color:#cabf9e; roughness:1" shadow="cast: true; receive: true"></a-box>';
    lh+='<a-box position="0 5 0" width="18" height="9" depth="9" material="src:#tex-facade1; repeat:5 3; roughness:1" shadow="cast: true; receive: true"></a-box>';
    lh+='<a-box position="0 9.8 0" width="18.7" height="0.7" depth="9.7" material="color:#b5482f; roughness:1" shadow="cast: true"></a-box>';
    lh+='<a-box position="0 3.4 4.5" width="4.8" height="6.6" depth="0.6" material="color:#e7ddc0; roughness:1" shadow="cast: true"></a-box>';
    lh+='<a-box position="0 2.8 4.85" width="2.8" height="4.8" depth="0.3" material="shader: flat; color:#2a2620"></a-box>';
    lh+='<a-circle position="0 7.3 4.86" radius="1.0" material="shader: flat; color:#f3ecd6"></a-circle>';
    lh+='<a-ring position="0 7.3 4.87" radius-inner="0.86" radius-outer="1.06" material="shader: flat; color:#7a1f24"></a-ring>';
    lh+='<a-box position="0 7.3 4.88" width="0.1" height="2.0" depth="0.02" material="shader: flat; color:#7a1f24"></a-box>';
    lh+='<a-box position="0 7.3 4.88" width="2.0" height="0.1" depth="0.02" material="shader: flat; color:#7a1f24"></a-box>';
    [-6.6,-3.7,3.7,6.6].forEach(function(wx){ lh+='<a-box position="'+wx+' 4.6 4.62" width="1.1" height="3.2" depth="0.1" material="shader: flat; color:#39506e"></a-box>'+'<a-box position="'+wx+' 6.35 4.62" width="1.1" height="0.12" depth="0.1" material="shader: flat; color:#c9b27a"></a-box>'; });
    lh+='<a-box position="-6.5 9 2" width="4.4" height="18" depth="4.4" material="src:#tex-facade1; repeat:1 5; roughness:1" shadow="cast: true; receive: true"></a-box>';
    lh+='<a-box position="-6.5 18.3 2" width="4.9" height="0.7" depth="4.9" material="color:#c9b27a; roughness:1" shadow="cast: true"></a-box>';
    lh+='<a-box position="-6.5 16.6 4.21" width="1.0" height="2.2" depth="0.1" material="shader: flat; color:#241f1a"></a-box>';
    lh+='<a-box position="-6.5 16.6 -0.21" width="1.0" height="2.2" depth="0.1" material="shader: flat; color:#241f1a"></a-box>';
    lh+='<a-box position="-8.71 16.6 2" width="0.1" height="2.2" depth="1.0" material="shader: flat; color:#241f1a"></a-box>';
    lh+='<a-box position="-4.29 16.6 2" width="0.1" height="2.2" depth="1.0" material="shader: flat; color:#241f1a"></a-box>';
    lh+='<a-cone position="-6.5 20.5 2" radius-bottom="3.7" radius-top="0" height="4.0" material="color:#b5482f; roughness:1" shadow="cast: true"></a-cone>';
    lh+='<a-sphere position="-6.5 22.8 2" radius="0.3" material="shader: flat; color:#ffcc33"></a-sphere>';
    lh+='<a-text value="DOUGHENY LIBRARY" position="2.4 1.5 4.9" align="center" width="7.5" color="#5a4a2a"></a-text>';
...
AFRAME.registerComponent('thirdperson',{
  ...
  tick:function(t,dt){
    ...
    if(moving){
      ...
      p.x=Math.max(-10.5,Math.min(10.5,p.x)); p.z=Math.max(-132,Math.min(13,p.z));
